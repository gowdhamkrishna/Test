...
app.post('/upload', upload.single('image'), (req, res) => {
  ...
  try {
    ...
    if (req.headers.host.includes('cloudshell.dev')) {
      // Use the Google Cloud Shell URL
      fileUrl = `https://${req.headers.host}/uploads/${req.file.filename}`;
    } else {
      // Use local environment URL
...
// Use process.env.PORT to work with Google Cloud environment or default to 5000
